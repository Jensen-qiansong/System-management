<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LyManger.aspx.cs" Inherits="Student_LyManger" %>
                     ...
                     <RowStyle BackColor="#DEDFDE" HorizontalAlign="Left" ForeColor="Black" />
                      <Columns>
                            <asp:TemplateField HeaderText="MessageTitle">
                                <ItemTemplate>
                                    <asp:Label ID="Topic" runat="server" Text='<%# Bind("Topic") %>' Width="608px"></asp:Label>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="View">
                                <ItemTemplate>
                                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "ShowLY.aspx?id="+Eval("id") %>'
                                        Text="View" Width="93px"></asp:HyperLink>
                                </ItemTemplate>
