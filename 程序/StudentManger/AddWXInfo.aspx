<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddWXInfo.aspx.cs" Inherits="Student_AddyeguiInfo" %>
  ...
  <TR>
    ...
    <TD vAlign=top width="100%" bgColor=#ffffff style="height: 61px">
      <TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
        <TR>
          <TD class=manageHead>
              Current Location：Addmaintainapply </TD></TR>
        <TR>
