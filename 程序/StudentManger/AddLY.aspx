<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddLY.aspx.cs" Inherits="Student_AddLY" %>
  ...
  <TR>
    ...
    <TD vAlign=top width="100%" bgColor=#ffffff style="height: 61px">
      <TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
        <TR>
          <TD class=manageHead>
              Current Location：AddMessage</TD></TR>
        <TR>
            ...
            <tr>
             ...
             <tr>
                 <td align="center" class="td2" style="width: 10%; height: 26px">
                     MessageTitle：</td>
                 <td class="td2" colspan="3" style="height: 26px">
