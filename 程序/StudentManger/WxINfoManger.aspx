<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WxINfoManger.aspx.cs" Inherits="Student_WxINfoManger" %>
  ...
  <TR>
    ...
    <TD vAlign=top width="100%" bgColor=#ffffff style="height: 61px">
      <TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
        <TR>
          <TD class=manageHead>
              Current Position: Maintenance Information Management</TD></TR>
          <tr>
                          ...
                          <asp:TemplateField HeaderText="dormitory building">
                            ...
                            <asp:TemplateField HeaderText="Dormitory number">
                               ...
                               <asp:TemplateField HeaderText="Username">
                                <ItemTemplate>
                                    <asp:Label ID="StName" runat="server" Text='<%# Bind("StName") %>' Width="80px"></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" Width="80px" />
                            </asp:TemplateField>
                               
                               <asp:TemplateField HeaderText="maintainproject">
                                <ItemTemplate>
                                    <asp:Label ID="YuanYIn" runat="server" Text='<%# Bind("YuanYIn") %>' Width="80px"></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" Width="80px" />
                            </asp:TemplateField>
                             <asp:TemplateField HeaderText="ismaintain">
                                <ItemTemplate>
                                    <asp:Label ID="IsWX" runat="server" Text='<%# Bind("IsWX") %>' Width="80px"></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" Width="80px" />
                            </asp:TemplateField>
                             <asp:TemplateField HeaderText="maintainTime">
                                <ItemTemplate>
                                    <asp:Label ID="ShiJian" runat="server" Text='<%# Bind("ShiJian") %>' Width="80px"></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" Width="80px" />
                            </asp:TemplateField>
                          <asp:TemplateField HeaderText="maintaininformation">
                                <ItemTemplate>
                                    <asp:Label ID="Ds" runat="server" Text='<%# Bind("Ds") %>' Width="80px"></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" Width="80px" />
                            </asp:TemplateField>
