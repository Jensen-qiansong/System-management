<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditNews.aspx.cs"  ValidateRequest="false"   EnableEventValidation="false"  Inherits="Admin_EditNews" %>
  ...
  <TR>
    ...
    <TD vAlign=top width="100%" bgColor=#ffffff style="height: 61px">
      <TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
        <TR>
          <TD class=manageHead>
              Current Location：Updateannouncement
          </TD></TR>
        <TR>
          <TD height=2 align="left">
            ...
            <tr>
              ...
              <asp:TextBox ID="TextBox1" runat="server" CssClass="label" Width="558px"></asp:TextBox></td>
               ...
               <td style="WIDTH: 10%; HEIGHT: 54px" class="td2" align="center">
