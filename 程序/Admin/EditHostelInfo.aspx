<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditHostelInfo.aspx.cs" Inherits="Admin_EditHostelInfo" %>
  ...
  <TR>
    ...
    <TD vAlign=top width="100%" bgColor=#ffffff style="height: 61px">
      <TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
        <TR>
          <TD class=manageHead>
              Current Location：Updatedormitoryinformation
          </TD></TR>
        <TR>
          <TD height=2 align="left">
            ...
            <tr>
             ...
             <tr>
                 ...
                 <td class="td2" colspan="3" style="height: 21px">
                     <asp:DropDownList ID="DropDownList2" runat="server">
                         <asp:ListItem>man生dormitory</asp:ListItem>
                         <asp:ListItem>female生dormitory</asp:ListItem>
                     </asp:DropDownList></td>
             </tr>
                 <tr>
                 <td align="center" class="td2" style="width: 10%; height: 21px">
             ...
             <tr>
                 <td align="center" class="td2" style="width: 10%; height: 21px">
                     cost of accommodation：</td>
                 <td class="td2" colspan="3" style="height: 21px">
                     <asp:TextBox ID="TextBox5" runat="server" CssClass="label" Width="127px"></asp:TextBox></td>
             </tr>
             <tr>
                 <td align="center" class="td2" style="width: 10%; height: 89px">
                     remarks：</td>
                 <td class="td2" colspan="3" style="height: 89px">
                     <asp:TextBox ID="TextBox3" runat="server" CssClass="label" Height="97px" TextMode="MultiLine"
                         Width="788px"></asp:TextBox></td>
             </tr>
             </table>
          </TD></TR>
          <tr>
