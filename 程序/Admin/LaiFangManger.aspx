<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LaiFangManger.aspx.cs" Inherits="Admin_LaiFangManger" %>
  ...
  <TR>
    ...
    <TD vAlign=top width="100%" bgColor=#ffffff style="height: 61px">
      <TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
        <TR>
          <TD class=manageHead>
              Current Location：guestVisit informationManager</TD></TR>
        <TR>
                          ...
                          <asp:TemplateField HeaderText="dormitory building">
                            ...
                            <asp:TemplateField HeaderText="Dormitory number">
                               ...
                               <asp:TemplateField HeaderText="Username">
                                <ItemTemplate>
                                    <asp:Label ID="StName" runat="server" Text='<%# Bind("StName") %>' Width="85px"></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center"  Width="80px" />
                            </asp:TemplateField>
                             
                               <asp:TemplateField HeaderText="Visitorsname">
                                <ItemTemplate>
                                    <asp:Label ID="LFName" runat="server" Text='<%# Bind("LFName") %>' Width="80px"></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center"  Width="80px" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="VisitorTime">
                                <ItemTemplate>
                             ...
                             <asp:TemplateField HeaderText="LeaveTime">
                                <ItemTemplate>
                                    <asp:Label ID="LiKaiShiJIan" runat="server" Text='<%# Bind("LiKaiShiJIan") %>' Width="80px"></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center"  Width="80px" />
                            </asp:TemplateField>
                               <asp:TemplateField HeaderText="Visitorpurpose">
                                <ItemTemplate>
                                    <asp:Label ID="Ds" runat="server" Text='<%# Bind("Ds") %>' Width="370px"></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center"  Width="80px" />
                            </asp:TemplateField>
