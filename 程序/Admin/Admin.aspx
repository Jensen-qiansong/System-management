  ...
  <TR>
    ...
    <TD vAlign=top width="100%" bgColor=#ffffff style="height: 61px">
      <TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
        <TR>
          <TD class=manageHead>Current Location：ManagerAccountinformationManager </TD></TR>
        <TR>
          <TD height=2 align="center">
              <asp:LinkButton ID="LinkButton2" runat="server" OnClick="LinkButton2_Click">AddManager information</asp:LinkButton>
                     ...
                     <RowStyle BackColor="#DEDFDE" HorizontalAlign="Left" ForeColor="Black" />
                      <Columns>
                          <asp:TemplateField HeaderText="Account">
                                <ItemTemplate>
                                    <asp:Label ID="Admin" runat="server" Text='<%# Bind("Name") %>'></asp:Label>
                                </ItemTemplate>
