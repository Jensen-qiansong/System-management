<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FloorInfoManger.aspx.cs" Inherits="Admin_FloorInfoManger" %>
  ...
  <TR>
    ...
    <TD vAlign=top width="100%" bgColor=#ffffff style="height: 61px">
      <TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
        <TR>
          <TD class=manageHead>
              Current Location：dormitory buildinginformationManager
          </TD></TR>
        <TR>
              ...
              <td align="left" height="2">
                  <asp:GridView ID="GvData" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                     ...
                     <RowStyle BackColor="#DEDFDE" HorizontalAlign="Left" ForeColor="Black" />
                      <Columns>
                          <asp:TemplateField HeaderText="floorNO">
                                <ItemTemplate>
                                    <asp:Label ID="Name" runat="server" Text='<%# Bind("Name") %>' Width="386px"></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" Width="80px" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="floorer">
                                <ItemTemplate>
                                    <asp:Label ID="manager" runat="server" Text='<%# Bind("manager") %>' Width="382px"></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" Width="80px" />
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Update">
                                <ItemTemplate>
                                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "EditFloorInfo.aspx?id="+Eval("id") %>'
