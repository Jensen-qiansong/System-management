<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HosteManger.aspx.cs" Inherits="Admin_HosteManger" %>
  ...
  <TR>
    ...
    <TD vAlign=top width="100%" bgColor=#ffffff style="height: 61px">
      <TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
        <TR>
          <TD class=manageHead>
              Current Location：dormitoryinformationManager
          </TD></TR>
        <TR>
                     ...
                     <RowStyle BackColor="#DEDFDE" HorizontalAlign="Left" ForeColor="Black" />
                      <Columns>
                          <asp:TemplateField HeaderText="dormitory building">
                                <ItemTemplate>
                                    <asp:Label ID="BName" runat="server" Text='<%# Bind("BName") %>' Width="135px"></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" Width="80px" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Dormitory number">
                                <ItemTemplate>
                                    <asp:Label ID="Num" runat="server" Text='<%# Bind("Num") %>' Width="100px"></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" Width="80px" />
                            </asp:TemplateField>
                              
                               <asp:TemplateField HeaderText="dormitory类别">
                                <ItemTemplate>
                                    <asp:Label ID="Sex" runat="server" Text='<%# Bind("Sex") %>' Width="100px"></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" Width="80px" />
                            </asp:TemplateField>
                               <asp:TemplateField HeaderText="Capacity">
                                <ItemTemplate>
                                    <asp:Label ID="RenShu" runat="server" Text='<%# Bind("RenShu") %>' Width="80px"></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" Width="80px" />
                            </asp:TemplateField>
                               <asp:TemplateField HeaderText="cost of accommodation">
                                <ItemTemplate>
                                    <asp:Label ID="FeiYong" runat="server" Text='<%# Bind("FeiYong") %>' Width="80px"></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" Width="80px" />
                            </asp:TemplateField>
                               <asp:TemplateField HeaderText="Free beds">
                                <ItemTemplate>
                                    <asp:Label ID="Kong" runat="server" Text='<%# Bind("Kong") %>' Width="80px"></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" Width="80px" />
                            </asp:TemplateField>
                              <asp:TemplateField HeaderText="Enrolled">
                                <ItemTemplate>
                                    <asp:Label ID="InNum" runat="server" Text='<%# Bind("InNum") %>' Width="80px"></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" Width="80px" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Update">
                                <ItemTemplate>
                                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "EditHostelInfo.aspx?id="+Eval("id") %>'
                                        Text="Update" Width="75px"></asp:HyperLink>
                                </ItemTemplate>
