  ...
  <TR>
    ...
    <TD vAlign=top width="100%" bgColor=#ffffff style="height: 61px">
      <TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
        <TR>
          <TD class=manageHead>Current Location：Student informationManager </TD></TR>
        <TR>
          <TD height=2 align="center">
              <asp:LinkButton ID="LinkButton2" runat="server" OnClick="LinkButton2_Click">AddStudent information</asp:LinkButton>
              <asp:Label ID="Label4" runat="server" ForeColor="Red"></asp:Label>
              <asp:LinkButton ID="LinkButton3" runat="server" OnClick="LinkButton3_Click">SearchStudent information</asp:LinkButton></TD></TR>
          <tr>
