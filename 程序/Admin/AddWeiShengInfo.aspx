<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddWeiShengInfo.aspx.cs" Inherits="Admin_AddWeiShengInfo" %>
 ...
 * 	
 * 	如果page面乱码，把下面包含汉字的定义项放到page面中即可
********************************************************/
  ...
  <TR>
    ...
    <TD vAlign=top width="100%" bgColor=#ffffff style="height: 61px">
      <TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
        <TR>
          <TD class=manageHead>
              Current Location：AddHealth information
          </TD></TR>
        <TR>
          <TD height=2 align="left">
            ...
            <tr>
             ...
             <tr>
                 <td align="center" class="td2" style="width: 10%; height: 91px">
                     Health information：</td>
                 <td class="td2" colspan="3" style="height: 91px">
                     <asp:TextBox ID="TextBox6" runat="server" CssClass="label" Height="91px" TextMode="MultiLine"
                         Width="698px"></asp:TextBox></td>
             </tr>
                  <tr>
                      <td align="center" class="td2" style="width: 10%; height: 31px">
                          Health score：</td>
                      <td class="td2" colspan="3" style="height: 31px">
                          <asp:TextBox ID="TextBox2" runat="server" Width="204px"></asp:TextBox></td>
                  </tr>
                  <tr>
                      <td align="center" class="td2" style="width: 10%; height: 31px">
                          Date of assessment：</td>
                      <td class="td2" colspan="3" style="height: 31px">
                          <asp:TextBox ID="TextBox3" runat="server" Width="204px" onclick="fPopCalendar(event,this,this)" onfocus="this.select()" ></asp:TextBox></td>
                  </tr>
                  <tr>
                      <td align="center" class="td2" style="width: 10%; height: 91px">
                          Upload photos：</td>
                      <td class="td2" colspan="3" style="height: 91px">
                          ...
                          <asp:Button ID="Button3" runat="server" OnClick="Button3_Click" Text="Upload Image" />
