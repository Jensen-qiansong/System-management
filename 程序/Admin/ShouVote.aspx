<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShouVote.aspx.cs" Inherits="Admin_ShouVote" %>
  ...
  <TR>
    ...
    <TD vAlign=top width="100%" bgColor=#ffffff style="height: 61px">
      <TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
        <TR>
          <TD class=manageHead>
              Current Location：Details of Voting</TD></TR>
        <TR>
              ...
              <td align="left" height="2">
                  <asp:GridView ID="GvData" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                     ...
                     <RowStyle BackColor="#DEDFDE" HorizontalAlign="Left" ForeColor="Black" />
                      <Columns>
                            <asp:TemplateField HeaderText="VotedormitoryName">
                                      <ItemTemplate>
                                          <%#Eval("FCName")%>
                                      </ItemTemplate>
                                      <HeaderStyle Width="90px" />
                                  </asp:TemplateField>
                                  <asp:TemplateField HeaderText="Vote人">
                                      <ItemTemplate>
                                          <%#Eval("UserName")%>
                                      </ItemTemplate>
                                      <HeaderStyle Width="90px" />
                                  </asp:TemplateField>
                                  <asp:TemplateField HeaderText="VoteContent">
                                      <ItemTemplate>
                                          <%#Eval("Titles")%>
                                      </ItemTemplate>
                                      <HeaderStyle Width="230px" />
                                  </asp:TemplateField>
                                  <asp:TemplateField HeaderText="VoteScore">
                                      <ItemTemplate>
                                          <%#Eval("FenShu")%>
                                      </ItemTemplate>
                                      <HeaderStyle Width="90px" />
