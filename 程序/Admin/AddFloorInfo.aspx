<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddFloorInfo.aspx.cs" Inherits="Admin_AddFloorInfo" %>
  ...
  <TR>
    ...
    <TD vAlign=top width="100%" bgColor=#ffffff style="height: 61px">
      <TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
        <TR>
          <TD class=manageHead>
              Location: Add Dormitory Building</TD></TR>
        <TR>
            ...
            <tr>
             ...
             <tr>
                 <td align="center" class="td2" style="width: 10%; height: 21px">
                     Building management：</td>
                 <td class="td2" colspan="3" style="height: 21px">
                     <asp:TextBox ID="TextBox2" runat="server" CssClass="label" Width="138px"></asp:TextBox>
                     <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="TextBox2"
                         ErrorMessage="*"></asp:RequiredFieldValidator></td>
             </tr>
             <tr>
                 <td align="center" class="td2" style="width: 10%; height: 120px">
                     remarks：</td>
                 <td class="td2" colspan="3" style="height: 120px">
                     <asp:TextBox ID="TextBox3" runat="server" CssClass="label" Height="166px" TextMode="MultiLine"
                         Width="699px"></asp:TextBox></td>
             </tr>
             </table>
          </TD></TR>
          <tr>
