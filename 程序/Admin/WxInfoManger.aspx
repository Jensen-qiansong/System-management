<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WxInfoManger.aspx.cs" Inherits="Admin_WxInfoManger" %>
  ...
  <TR>
    ...
    <TD vAlign=top width="100%" bgColor=#ffffff style="height: 61px">
      <TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
        <TR>
          <TD class=manageHead>
              Current Location：maintaininformationManager</TD></TR>
        <TR>
                      ...
                      <Columns>
                          <asp:TemplateField HeaderText="dormitory building">
                            ...
                            <asp:TemplateField HeaderText="Dormitory number">
                               ...
                               <asp:TemplateField HeaderText="isHandle">
                                <ItemTemplate>
                                    <asp:Label ID="IsWX" runat="server" Text='<%# Bind("IsWX") %>' Width="180px"></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" Width="80px" />
                            </asp:TemplateField>
                               <asp:TemplateField HeaderText="maintainapply ">
                                <ItemTemplate>
                                    <asp:Label ID="YuanYIn" runat="server" Text='<%# Bind("YuanYIn") %>' Width="180px"></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" Width="80px" />
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Handle">
                                <ItemTemplate>
                                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "ChkWX.aspx?id="+Eval("id") %>'
                                        Text="Handle" Width="75px"></asp:HyperLink>
                                </ItemTemplate>
